...
yama = function(){
    ...
    function applyParamToDom(yamaCompDesc, contextBuffer, bDom, paramName, paramAccessorName){
        var listenerParams = {'text':1, 'avalue':1};
        var senderParams = {'onclick':1, 'value':1, 'onenter':1}
        ...
        if (senderParams[paramName]){
            if (paramName == 'onclick'){
                    ...
                    return function(){
                        ...
                        bDom.onclick = function(){
                            yamaCompDesc[paramAccessorName].call(curContext, function(paramName){
                                var contInfo = findContext(contextBufferWhenBound, paramName);
    ...
    function drawFromLines(yamaCompDesc, contextBuffer, rootCont, needsRoot, lines, startIndex, minIndent){
        ...
        if (k < lines.length){
            ...
            if (rootCont){
                var nativeElems = {'div':1, 'span':1, 'input':1};
